    ...
    <div class="stats-grid">
      <div class="stat-card">
        <div class="stat-header">
          <span class="stat-label">充电时间</span>
        </div>
      ...
      <div class="stat-card highlight-green">
        <div class="stat-header">
          <span class="stat-label">充电电量</span>
        </div>
        <div class="stat-content">
          <div class="stat-value">123</div>
          <div class="stat-trend positive">
            <span>较昨日</span>
            <span class="trend-value">+6名</span>
          </div>
        </div>
        <div class="mini-chart">
      ...
      <div class="stat-card">
        <div class="stat-header">
          <span class="stat-label">充电金额</span>
        </div>
        <div class="stat-content">
          <div class="stat-value">123</div>
          <div class="stat-trend negative">
            <span>较昨日</span>
            <span class="trend-value">-8名</span>
          </div>
        </div>
        <div class="mini-chart">
          <svg viewBox="0 0 100 30" class="line-chart">
      ...
      <div class="stat-card">
        ...
        <div class="stat-content">
          ...
          <div class="stat-trend negative">
            <span>较昨日</span>
            <span class="trend-value">-26%</span>
          </div>
        </div>
        <div class="mini-chart">
  ...
  const option = {
    ...
    series: [
      ...
      },
      {
        ...
        areaStyle: {
          color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
            { offset: 0, color: 'rgba(94, 201, 143, 0.3)' },
            { offset: 1, color: 'rgba(94, 201, 143, 0.05)' }
          ])
        }
      }
    ]
