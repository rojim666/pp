...
const tabs = [
  ...
  { type: 'user', label: '用户', icon: 'user' }
]

const notifications = ref([
  { id: 1, type: 'success', title: '充电完成', message: '充电桩#001 已完成充电，本次充电58.5kWh，费用¥87.5，已自动结算完成', time: '5分钟前', read: false, category: '设备', tab: 'device' },
  { id: 2, type: 'warning', title: '设备告警', message: '充电桩#003 电压异常(245V)，超出正常范围220V±10%，请及时检查维护，避免影响充电服务', time: '15分钟前', read: false, category: '设备', tab: 'device' },
  { id: 3, type: 'info', title: '系统更新', message: '系统将于今晚23:00进行维护更新，预计耗时30分钟，更新期间部分功能暂时不可用，请提前做好准备', time: '1小时前', read: true, category: '系统', tab: 'system' },
  { id: 4, type: 'success', title: '用户注册', message: '新用户 张三 (手机: 138****5678) 已成功注册并完成实名认证，当前系统总用户数达到1,234人', time: '2小时前', read: false, category: '用户', tab: 'user' },
  { id: 5, type: 'info', title: '费用结算', message: '今日充电费用已自动结算，总计¥12,458.50，已转入账户。其中快充收入¥8,234，慢充收入¥4,224.50', time: '3小时前', read: true, category: '系统', tab: 'system' },
  { id: 6, type: 'error', title: '支付失败', message: '用户 李四 的订单#20231027001 支付失败，原因：余额不足。订单金额¥156.80，账户余额¥50.00', time: '4小时前', read: false, category: '用户', tab: 'user' },
  { id: 7, type: 'warning', title: '充电异常', message: '充电桩#005 检测到异常断电，充电进度75%时中断，系统已自动停止充电并按实际充电量退款¥68.50', time: '5小时前', read: true, category: '设备', tab: 'device' },
  { id: 8, type: 'success', title: '维护完成', message: '充电桩#002 定期维护已完成，更换充电枪线缆，清理散热系统，设备状态正常，可继续提供充电服务', time: '6小时前', read: true, category: '设备', tab: 'device' },
  { id: 9, type: 'info', title: '数据备份', message: '系统数据备份已完成，备份时间：2023-10-27 02:00，备份大小：2.3GB，存储位置：云端备份服务器', time: '8小时前', read: true, category: '系统', tab: 'system' },
  { id: 10, type: 'success', title: '新增充电桩', message: '充电桩#012 已成功添加到系统，位置：A区3号车位，设备型号：XDZ-120KW，状态正常可用', time: '12小时前', read: true, category: '设备', tab: 'device' },
])
...
const todayCount = computed(() => notifications.value.filter(n => n.time.includes('分钟前') || n.time.includes('小时前')).length)
