          ...
          <div class="action-wrapper">
            ...
            <div v-if="showUserMenu" class="dropdown user-menu-dropdown">
              <div class="user-profile">
                <img src="https://via.placeholder.com/64" alt="用户头像" class="profile-avatar" />
                <div class="profile-info">
                  <div class="profile-name">张三</div>
                  <div class="profile-role">系统管理员</div>
                  <div class="profile-email">admin@charging.com</div>
                </div>
...
const chargingMenu = [
  { path: '/charging', name: '充电桩管理', icon: 'zap' },
...
const notifications = ref([
  { id: 1, type: 'success', title: '充电完成', message: '充电桩#001 已完成充电，本次充电58.5kWh，费用¥87.5', time: '5分钟前', read: false, category: '设备', tab: 'device' },
  { id: 2, type: 'warning', title: '设备告警', message: '充电桩#003 电压异常(245V)，超出正常范围，请及时检查维护', time: '15分钟前', read: false, category: '设备', tab: 'device' },
  { id: 3, type: 'info', title: '系统更新', message: '系统将于今晚23:00进行维护更新，预计耗时30分钟', time: '1小时前', read: true, category: '系统', tab: 'system' },
  { id: 4, type: 'success', title: '用户注册', message: '新用户 张三 (手机: 138****5678) 已成功注册并完成实名认证', time: '2小时前', read: true, category: '用户', tab: 'user' },
  { id: 5, type: 'info', title: '费用结算', message: '今日充电费用已自动结算，总计¥12,458.50，已转入账户', time: '3小时前', read: true, category: '系统', tab: 'system' },
  { id: 6, type: 'error', title: '支付失败', message: '用户 李四 的订单支付失败，原因：余额不足', time: '4小时前', read: false, category: '用户', tab: 'user' },
  { id: 7, type: 'warning', title: '充电异常', message: '充电桩#005 检测到异常断电，已自动停止充电并退款', time: '5小时前', read: true, category: '设备', tab: 'device' },
  { id: 8, type: 'success', title: '维护完成', message: '充电桩#002 定期维护已完成，设备状态正常', time: '6小时前', read: true, category: '设备', tab: 'device' }
])
