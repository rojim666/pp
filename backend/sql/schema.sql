...
CREATE TABLE `tariff_config` (
    ...
    `parking_fee` DECIMAL(10,2) DEFAULT 0.00 COMMENT '停车费(元/小时)',
...
-- 插入默认费率配置
INSERT INTO `tariff_config` (`name`, `peak_price`, `valley_price`, `normal_price`, `service_fee`, `parking_fee`, `peak_hours`, `valley_hours`, `is_default`, `effective_date`, `description`)
VALUES ('标准费率', 1.20, 0.60, 0.80, 0.80, 5.00, '["08:00-12:00","18:00-22:00"]', '["00:00-06:00"]', 1, '2024-01-01', '工作日标准费率');
